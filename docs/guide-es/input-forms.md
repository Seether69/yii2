...
La forma primaria de utilizar Formularios en Yii es a trávez de la clase [[yii\widgets\ActiveForm]]. Este enfoque debe preferirse cuando
cuando el formulario se basa en un modelo. Adicionalmente, algunas veces son útiles los metódos provistos en [[yii\helpers\Html]], 
estos generalmente son usados para agregar botones y textos de ayuda para cualquier formulario.
